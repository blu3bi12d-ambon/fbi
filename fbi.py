...
''' 
     ...
     Facebook Information ( BLU3BI12D-AMBON )
...
def baliho():
	try:
		...
		print (W + '     [' + G +'Facebook Information Created By Blu3bi12d-Ambon'+ W + ']')
		print ' '
####################################################################
#		    Print In terminal
def show_program():
...
def bot():
  try:
	...
	cek = raw_input(R + 'H3NU' + W +'/' + R +'Bot ' + W + '>> ')
